...
export default function () {
  app.get("/content/api/pages/fortnite-game", async (c) => {
    ...
    content = Object.assign(
      {},
      content,
      { eventscreens: game.eventscreens },
      { battlepasspurchase: game.battlepasspurchase },
      { crewscreendata: game.crewscreendata },
      {
        emergencynotice: {
          news: {
            platform_messages: [],
            ...
            motds: [
              {
                entryType: "Website",
                image:
                  "https://raw.githubusercontent.com/NeoniteDev/NeoniteV2/main/public/Neonite1024.png",
                tileImage:
                  "https://raw.githubusercontent.com/NeoniteDev/NeoniteV2/main/public/Neonite1024.png",
                videoMute: false,
                hidden: false,
